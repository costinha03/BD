...
```
As entidades são: a encomenda, produto e fornecedor;

-> Encomenda: número, data, fornecedor;
-> Produto: código, nome, preço, e taxa de IVA;
-> Fornecedor: código interno, nome, NIF, endereço, nº de fax e condições de pagamento

Um produto pode pertencer a nenhuma ou a mais encomendas;
Um produto pertence a um só fornecedor;
Uma encomenda tem pelo menos um produto e um só fornecedor;
...
```
Todas as relações são binárias.
Encomenda-Forncedor: Todas as encomendas têm obrigatoriamente 1 fornecedor e cada fornecedor pode ter N encomendas;
Encomenda-produto: Um produto pode pertencer a M encomendas e uma encomenda tem, obrigatoriamente 1 ou mais produtos;
Fornecedor-Tipo de fornecedor: Um fornecedor tem obrigatoriamente um tipo e um tipo pode ter N fornecedores.
```
