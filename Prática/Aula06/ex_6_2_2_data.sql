insert into StockManagement.tipo_fornecedor (codigo, designacao)
values
    (101, 'Carnes'),
    (102, 'Laticinios'),
...
insert into StockManagement.fornecedor (nif, nome, fax, endereco, condpag, tipo)
values
...
insert into StockManagement.produto (codigo, nome, preco, iva, unidades)
values
...
insert into StockManagement.encomenda (numero, data, fornecedor)
values
...
insert into StockManagement.item (numEnc, codProd, unidades)
values
    (1, 10001, 200),
    (1, 10004, 300),
    (2, 10002, 1200),
